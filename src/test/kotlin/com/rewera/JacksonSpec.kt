...
import com.rewera.modules.Jackson.mapper
...
class JacksonSpec {
    ...
    @Nested
    @DisplayName("Jackson strictMapper when expecting String")
    inner class ExpectedStringSpec {
        ...
        fun `and provided with String should return this String`() {
            val input = "\"1234567\""
            mapper.readValue(input, expectedClass) shouldBe "1234567"
        }

        @Test
        fun `and provided with Integer should throw an exception`() {
            val input = "1234567"
            shouldThrow<MismatchedInputException> { mapper.readValue(input, expectedClass) }
        }
    ...
    @Nested
    @DisplayName("Jackson strictMapper when expecting Integer")
    ...
    @Nested
    @DisplayName("Jackson strictMapper when expecting Double")
    inner class ExpectedDoubleSpec {
        ...
        fun `and provided with Double number should return this Double`() {
            val input = "123.4567"
            mapper.readValue(input, expectedClass) shouldBe 123.4567
        }

        @Test
        fun `and provided with Integer should return this Integer as Double`() {
            val input = "1234567"
            mapper.readValue(input, expectedClass) shouldBe 1234567.0
        }
    ...
    @Nested
    @DisplayName("Jackson strictMapper when expecting Boolean")
    inner class ExpectedBooleanSpec {
        ...
        fun `and provided with Boolean should return this Boolean`() {
            val input = "true"
            mapper.readValue(input, expectedClass) shouldBe true
        }
    ...
    @Nested
    @DisplayName("Jackson strictMapper when expecting Object type")
    inner class ExpectedObjectSpec {
        ...
        fun `and provided with Object type with correct field type should return this Object type`() {
            val input = "{\"someParam\":\"Test value\"}"
            mapper.readValue(input, expectedClass) shouldBe TestDataClass("Test value")
        }
    ...
    @Nested
    @DisplayName("Jackson strictMapper when expecting Array")
    inner class ExpectedArraySpec {
        ...
        fun `and provided with Array of Strings should return this Array`() {
            val input = "[\"Test value 1\",\"Test value 2\",\"Test value 3\"]"
            mapper.readValue(input, expectedClass) shouldBe arrayOf(
                "Test value 1",
                "Test value 2",
                "Test value 3"
            )
        ...
        fun `and provided with Array of Integers should return this Array`() {
            val input = "[1, 2, 3]"
            mapper.readValue(input, expectedClass) shouldBe arrayOf(1, 2, 3)
        }

        @Test
        fun `and provided with String should throw an exception`() {
            val input = "\"1234567\""
            shouldThrow<InvalidDefinitionException> { mapper.readValue(input, expectedClass) }
        }
    ...
    @Nested
    @DisplayName("Jackson strictMapper when expecting Array of specific type")
    inner class ExpectedTypedArraySpec {
        ...
        fun `and provided with TypeReference and Array of correct type should return Array of this type`() {
            ...
            mapper.readValue(input, typeReference) shouldBe arrayOf(
                "Test value 1",
                "Test value 2",
                "Test value 3"
            )
        ...
        fun `and provided with TypeReference and Array of incorrect type should throw an exception`() {
            ...
            shouldThrow<MismatchedInputException> { mapper.readValue(input, typeReference) }
        }
    }
